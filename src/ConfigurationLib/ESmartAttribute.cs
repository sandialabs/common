...
namespace gov.sandia.sld.common.configuration
{
    ...
    public enum ESmartAttribute : byte
    {
        [Description("Invalid")]
        Invalid = 0x00,
        ...
        [Description("Vibration during write")]
        VibrationDuringWrite = 0xD3,
        [Description("Shock during write")]
        ...
        [Description("Free-fall protection")]
